...
#define PIN_ENABLE_FEED 21 // this is the enable for the feed stepper motor, make sure is installed. 
#define PIN_ENC_A 3
#define PIN_ENC_B 2
#define PIN_BUTTON_ENC 4
#define PIN_BUTTON_RED 13
#define PIN_LED 13   // I dont use this personally,
#define PIN_SENSOR A8 //moved to a8 due to a0 being occupied
...
AccelStepper stepCut(1, 19, 18); // (DRIVER, STEP, DIR)(19 Red,18 Black) // the "1" after stepCut indicates the use of a motor driver module//
// for the stepper motor to the driver for the cutter on the larger motor driver, red to a, blue to a-, green to b, black to b-, // 
AccelStepper stepFeed(1, 15, 14); // (DRIVER Type, step, dir)( black 14, red 15, white to 5v) //
// for the stepper motor to the driver for the feeder, blue to b2, red to b1, green to a2, black to a1 //
